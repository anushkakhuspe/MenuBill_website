...
var data: { val: number, name: string, price: number }[] = [];
...
var serial_no: number; //to display serial no. in bill
serial_no = 0; //initialisation of serial_no with zero
var total_bill: number;
total_bill = 0;

//function to calculate total bill
function calc() {
    var selectedoption: HTMLInputElement = <HTMLInputElement>document.getElementById("s1");
    var quantity = parseInt((<HTMLInputElement>document.getElementById("n1")).value);
